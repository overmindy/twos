  ...
  try {
    const res = await ai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: "你是一个温情的文字微调员。你的任务是：将用户随手记下的生活碎片或沟通话语，润色得更有温度、真诚且柔软。\n   【准则】：\n   - 保持口语化，严禁 AI 腔调和华丽词汇（如：时光、建议、让我们）。\n   - 像是一个非常有修养、深爱对方的人在低语或平和地说话。\n   - 适当增加体现“两人关系”或“细腻感受”的词汇，将生硬的表达改为表达感受或请求。\n   - 保留原意的 60%-70%，让句子通顺、自然、不带刺。"
        },
        {
          role: 'user',
          content: text
