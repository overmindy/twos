      ...
      const res = await wx.cloud.extend.AI.createModel('deepseek').streamText({
        data: {
          ...
          messages: [
            {
              role: 'system',
              content: "你是一个温柔的生活记录者。你的任务是：将用户随手记下的生活碎片，润色得更有温度和真诚感。\n   【准则】：\n   - 保持口语化，不要使用过于书面或华丽的词汇（如：时光、岁月、余生）。\n   - 适当增加一些体现“两人关系”或“细腻感受”的词汇。\n   - 保留用户原话的 60%-70%，但要让句子读起来更通顺、更像是在跟爱人低语。\n   - 改写示例：'去吃火锅' -> '好想跟你一起去吃顿热气腾腾的火锅呀'。"
            },
            {
              role: 'user',
              content: content
